...
public class FragmentLinealSplines extends Fragment {
    ...
    private void setTitle(){
        title.setText(R.string.lineal_splines);
    }
    ...
    private void setSolveFunction(){
        solve.setOnClickListener(v -> {
            ...
            try {
                ...
                double[] results  = LinealSplines.linealSplines(X,Y,X_values);
