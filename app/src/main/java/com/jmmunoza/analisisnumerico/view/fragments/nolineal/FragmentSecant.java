...
public class FragmentSecant extends Fragment {
    ...
    private void setTitle(){
        title.setText(R.string.secant_method);
    }
        ...
        solve.setOnClickListener(v -> {
            ...
            try {
                ...
                if(xi >= xf){
                    ...
                    boolean worked = Secant.calculate(fx, xi, xf, tol, i_max, errorType, (i, x, e) -> {
