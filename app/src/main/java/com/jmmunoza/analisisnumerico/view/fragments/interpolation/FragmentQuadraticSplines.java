...
public class FragmentQuadraticSplines extends Fragment {
    ...
    public FragmentQuadraticSplines(){
    ...
    private void setTitle(){
        title.setText(R.string.quadratic_splines);
    }
    ...
    private void setSolveFunction(){
        solve.setOnClickListener(v -> {
            ...
            try {
                ...
                double[] results  = QuadraticSplines.quadraticSplines(X,Y,X_values);
