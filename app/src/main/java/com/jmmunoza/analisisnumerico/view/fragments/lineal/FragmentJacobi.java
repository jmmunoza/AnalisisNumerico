...
public class FragmentJacobi extends Fragment {
    ...
    private void setSolveFunction(){
        solve.setOnClickListener(v -> {
            ...
            try {
                ...
                double[] resultsAb = Jacobi.jacobi(A, b, i_max, tol, errorType, (i, x, e) -> {
                    String result = "";
