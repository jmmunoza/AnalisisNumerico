...
public class FragmentDividedDifferences extends Fragment {
    ...
    public FragmentDividedDifferences(){
    ...
    private void setTitle(){
        title.setText(R.string.divided_differences);
    }
    ...
    private void setSolveFunction(){
        solve.setOnClickListener(v -> {
            ...
            try {
                ...
                double[] results = DividedDifferences.dividedDifferences(X,Y,X_values);
